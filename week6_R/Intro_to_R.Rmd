...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/lilly/Desktop/QBIO490/qbio_490_lilly")) 
```
...
## vector:
three_fav_colors <- c("blue", "purple", "black")
```
...
if (2 > 1) {
  ...
  print("2 is not greater than 1, 1 is not less than 2")
}
```
